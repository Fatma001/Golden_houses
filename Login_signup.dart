            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("images/houses.jpg"),
                      fit: BoxFit.fill)),
              child: Container(
                    ...
                    RichText(
                      text: TextSpan(
                          ...
                          style: TextStyle(
                            fontSize: 20,
                            letterSpacing: 2,
                            color: Color(0xFFB4822E),
                          ),
                          children: [
                            TextSpan(
                              text: isSignupScreen ? " GOLDEN Houses," : " Back,",
                              style: TextStyle(
                                fontSize: 20,
              ...
              text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      ...
                      style: TextStyle(color: Color(0xFFB4822E)),
                    ),
                  ]),
            ),
          ),
          ...
          child: !showShadow
            ...
            decoration: BoxDecoration(
                gradient: LinearGradient(
                    colors: [Colors.orange[200], Color(0xFFB4822E)],
